...
import 'package:edtech_application/data/model/response/base/error_response.dart';
        ...
        if (error is DioException) {
          switch (error.type) {
            ...
            case DioExceptionType.badCertificate:
              errorDescription = "Certificate issue";
            case DioExceptionType.connectionError:
              errorDescription = "Connection time out your network is week please try again";
          }
        } else {
